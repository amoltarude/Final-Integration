...
public class CategoryController {
	 ...
	 public ResponseEntity<?> deleteCategory(@PathVariable String id, HttpSession session) {
				...
				try {
					if(categoryService.deleteCategory(id))
					 	...
					 	return new ResponseEntity<>("Conflict",HttpStatus.NOT_FOUND);
	...
	@GetMapping("/api/v1/category/getByUserId/{id}")
	public ResponseEntity<?> getCategoryByUserId(@PathVariable("id") String userId){
		List<Category> cats = categoryService.getAllCategoryByUserId(userId);
