...
import com.stackroute.keepnote.service.NoteSequenceService;
...
public class NoteController {
	...
	public ResponseEntity<?> createNote(@RequestBody Note note) {
		...
		try {
			note.setNoteId(noteSequenceService.getNextSequence("noteSequence"));
	...
	public ResponseEntity<?> getAllNoteByUserId(@PathVariable("userId") String userId) {
		...
		return new ResponseEntity<>(allNoteByUserId, headers, HttpStatus.OK);
	}
	/*
