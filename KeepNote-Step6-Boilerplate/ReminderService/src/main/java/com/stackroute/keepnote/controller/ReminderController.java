...
public class ReminderController {
	...
	public ResponseEntity<?>deleteReminder(@PathVariable String id,HttpSession session){
			...
			try {
				if(service.deleteReminder(id))
					...
					return new ResponseEntity<>("Reminder can't be deleted", HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<?> getAllReminders(){
		...
		if (allReminders!=null) {
			return new ResponseEntity<>(allReminders, HttpStatus.OK);
		} else {
			return new ResponseEntity<>(allReminders, HttpStatus.NOT_FOUND);
		}
	}
